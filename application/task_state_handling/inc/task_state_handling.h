...
extern void ap_state_config_timefile_get(TIME_T *time);
extern void ap_state_config_timefile_set(TIME_T time);
...
extern void ap_state_handing_intime_init(TIME_T intime);
