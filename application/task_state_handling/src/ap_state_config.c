...
void ap_state_config_default_set(void)
{
	...
	ap_state_config_voice_record_switch_set(VIDEO_VOICE_ACQUISITION_SWITCH); //mic on
	ap_state_config_video_resolution_set(VIDEO_SIZE);	//720P
	ap_state_config_burst_set(CONTINUOUS_SHOOTING_SWITCH);	//连拍off  //Liuxi modified in 2015-01-15
	...
	ap_state_config_pic_size_set(CAPTURE_SIZE);
