...
// GPIO
	...
	#define USE_IOKEY_NO					1  // IO-Key 盎代穦ノ硂跑秖
    ...
    #define	VIDEO_KEY						IO_A7
	#define	CAPTURE_KEY						IO_A6
...
//----------------------------------------------------------------------------------    
    ...
    #define CAPTURE_KEY_TO_SAVE             	CUSTOM_OFF  //拍照键保存录像文件
    // 1-> 1min, 2-> 2min, 3-> 3min, 4-> 5min, 5-> 7min, 6-> 10min, 7-> 15min, 8-> 20min
    #define AUTO_SAVE_VIDEO_TIME            	6 		   //自动保存录像时间 
    ...
    #define CAPTURE_SIZE						8		   //照片分辨率
    // 0-> 1920*1080, 1-> 1440*1080, 2-> 1280*720, 3-> 848*480, 4-> 640*480, 5-> 320*240    
    #define VIDEO_SIZE							2 		   //录像分辨率
    
//====================Liuxi modified in 2015-01-15==================================    
    #define LED1							IO_D13//IO_D10
    #define LED2							IO_D10//IO_D13 red

    #define CDSP_IQ							GPCV1248_JVIN_V1_0//GPCV1248_C6_V2_0	
    #define PRODUCT_NUM                     2656
	#define PRODUCT_DATA                    20161107
	#define PROGRAM_VERSION_NUM             1//2602_101
#endif
